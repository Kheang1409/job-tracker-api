...
{
    Task<Candidate> GetByIdAsync(string AuthorId, string JobPostId, string CandidateId);
    Task<IEnumerable<Candidate>> GetAllAsync(string AuthorId, string JobPostId, int PageNumber, int Limit);
